              ...
              >
                <FadeIn className="space-y-5">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-[var(--landing-heading)] leading-relaxed whitespace-pre-line font-light">
                      <span className="font-medium text-[var(--landing-accent)]">
                        해결 ·{" "}
                      </span>
                      {b.solution}
                    </p>
                ...
                <FadeIn
                  delay={0.1}
                  className="shadow-[rgba(50,50,93,0.25)_0px_30px_45px_-30px,rgba(0,0,0,0.1)_0px_18px_36px_-18px] rounded-xl"
                >
