...
export const config = {
  matcher: [
    // 제외:
    //   - auth 라우트, 정적 파일, 포탈 (공개), favicon, 랜딩/가격/약관/환불 공개 페이지
