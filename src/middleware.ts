...
export const config = {
  matcher: [
    ...
    "/((?!_next/static|_next/image|favicon.ico|robots.txt|sitemap.xml|auth|portal|pricing|qna|terms|refund-policy|api/auth|api/portal|api/qna|api/v1|api/cron|api/track-event|api/demo-request|.*\\.(?:png|jpg|jpeg|gif|svg|webp|ico|woff2?|ttf|otf)).*)",
  ],
};
