...
export const TRADES: Trade[] = [
  { id:"demolition",name:"철거",icon:"🔨",group:"기초",phase:1,baseDays:2,costMin:120000,costMax:180000,unit:"평",deps:[],parallel:[],requires:[],skipRisk:"high",
  ...
  { id:"window",name:"창호(샤시)",icon:"🪟",group:"기초",phase:2,baseDays:1,costMin:250000,costMax:400000,unit:"개소",deps:["demolition"],parallel:["plumbing","electric"],requires:["demolition"],skipRisk:"medium",
  ...
  { id:"plumbing",name:"설비(배관)",icon:"🔧",group:"기초",phase:2,baseDays:3,costMin:180000,costMax:280000,unit:"평",deps:["demolition"],parallel:["window","electric"],requires:["demolition"],skipRisk:"high",
  ...
  { id:"electric",name:"전기",icon:"⚡",group:"기초",phase:2,baseDays:2,costMin:100000,costMax:160000,unit:"평",deps:["demolition"],parallel:["window","plumbing"],requires:["demolition"],skipRisk:"high",
  ...
  { id:"waterproof",name:"방수",icon:"💧",group:"습식",phase:3,baseDays:2,costMin:60000,costMax:100000,unit:"평",deps:["plumbing"],parallel:[],requires:["plumbing"],skipRisk:"critical",
  ...
  { id:"tile",name:"타일",icon:"🧱",group:"습식",phase:3,baseDays:4,costMin:150000,costMax:280000,unit:"평",deps:["waterproof"],parallel:["carpentry"],requires:["waterproof"],skipRisk:"medium",
  ...
  { id:"carpentry",name:"목공",icon:"🪚",group:"마감준비",phase:3,baseDays:4,costMin:200000,costMax:320000,unit:"평",deps:["electric"],parallel:["tile"],requires:["electric"],skipRisk:"medium",
  ...
  { id:"door",name:"도어",icon:"🚪",group:"마감준비",phase:4,baseDays:1,costMin:300000,costMax:600000,unit:"개",deps:["carpentry"],parallel:["film"],requires:["carpentry"],skipRisk:"low",
  ...
  { id:"film",name:"필름/시트",icon:"🎞️",group:"마감",phase:4,baseDays:2,costMin:60000,costMax:120000,unit:"평",deps:["carpentry"],parallel:["door"],requires:["carpentry"],skipRisk:"low",
  ...
  { id:"floor",name:"마루/바닥",icon:"🪵",group:"마감",phase:5,baseDays:2,costMin:130000,costMax:250000,unit:"평",deps:["carpentry","tile"],parallel:[],requires:["carpentry"],skipRisk:"medium",
  ...
  { id:"paint",name:"페인트",icon:"🎨",group:"마감",phase:5,baseDays:2,costMin:80000,costMax:140000,unit:"평",deps:["carpentry"],parallel:["floor"],requires:["carpentry"],skipRisk:"low",
  ...
  { id:"wallpaper",name:"도배",icon:"📜",group:"마감",phase:5,baseDays:2,costMin:80000,costMax:130000,unit:"평",deps:["carpentry","film"],parallel:["floor"],requires:["carpentry"],skipRisk:"low",
  ...
  { id:"lighting",name:"조명",icon:"💡",group:"설치",phase:6,baseDays:1,costMin:60000,costMax:150000,unit:"개소",deps:["wallpaper","paint"],parallel:["furniture"],requires:[],skipRisk:"low",
  ...
  { id:"furniture",name:"가구",icon:"🪑",group:"설치",phase:6,baseDays:2,costMin:250000,costMax:500000,unit:"평",deps:["wallpaper","floor"],parallel:["lighting"],requires:["carpentry"],skipRisk:"medium",
  ...
  { id:"accessory",name:"욕실악세사리",icon:"🚿",group:"설치",phase:6,baseDays:1,costMin:30000,costMax:80000,unit:"평",deps:["tile"],parallel:["lighting"],requires:["tile"],skipRisk:"medium",
  ...
  { id:"silicon",name:"실리콘/코킹",icon:"💉",group:"마무리",phase:7,baseDays:1,costMin:20000,costMax:40000,unit:"평",deps:["furniture","lighting","accessory"],parallel:[],requires:[],skipRisk:"low",
  ...
  { id:"cleaning",name:"입주청소",icon:"✨",group:"마무리",phase:8,baseDays:1,costMin:25000,costMax:45000,unit:"평",deps:["silicon"],parallel:[],requires:[],skipRisk:"low",
