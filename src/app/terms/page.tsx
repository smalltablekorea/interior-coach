        ...
        <div className="space-y-8 text-sm leading-relaxed text-[var(--muted)]">
          ...
          <section>
            <div className="p-5 rounded-2xl bg-blue-500/5 border border-blue-500/20">
              ...
              <ul className="list-disc list-inside space-y-1.5">
                <li><strong className="text-[var(--foreground)]">프로 분석권 (1회권 / 3회권)</strong>: 결제일로부터 180일(6개월) 이내 사용 가능합니다. 분석 완료 후 결과 리포트는 결제일로부터 180일간 열람 가능하며, 해당 기간 경과 시 미사용 분석권은 자동 소멸됩니다. 소멸 전 환불 요청이 가능합니다.</li>
                <li><strong className="text-[var(--foreground)]">월간 구독 (스타터 / 프로 플랜)</strong>: 결제일로부터 1개월간 제공됩니다. 갱신일 전 해지하면 다음 달부터 과금되지 않습니다.</li>
                <li><strong className="text-[var(--foreground)]">무료 분석권</strong>: 회원가입 시 제공되는 무료 분석권은 가입일로부터 180일(6개월)간 유효합니다.</li>
              </ul>
            </div>
          </section>
