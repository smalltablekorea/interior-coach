      ...
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full py-3 rounded-xl border border-[var(--border)] text-sm font-medium hover:bg-white/[0.04] transition-colors flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-[#FEE500] text-[#191919] text-sm font-medium hover:bg-[#FDD835] transition-colors flex items-center justify-center gap-2"
          >
            <svg width="18" height="18" viewBox="0 0 24 24">
